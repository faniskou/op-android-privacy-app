...
/**
 * Test for /appsIdentity/groups
 */
Test('/appsIdentity/groups', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         */
        t.test('test getgroups get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/appsIdentity/groups']['get']['responses']['200']['schema']);
