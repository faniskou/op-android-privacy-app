...
/**
 * Test for /appsIdentity/{group}
 */
Test('/appsIdentity/{group}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         */
        t.test('test getgroup get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/appsIdentity/{group}']['get']['responses']['200']['schema']);
         ...
         * responses: 200, 405
         */
        t.test('test addgroup put operation', function (t) {
            Mockgen().requests({
                path: '/appsIdentity/{group}',
                operation: 'put'
            }, function (err, mock) {
