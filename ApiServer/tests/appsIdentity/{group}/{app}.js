...
/**
 * Test for /appsIdentity/{group}/{app}
 */
Test('/appsIdentity/{group}/{app}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         */
        t.test('test getgroupapp get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/appsIdentity/{group}/{app}']['get']['responses']['200']['schema']);
