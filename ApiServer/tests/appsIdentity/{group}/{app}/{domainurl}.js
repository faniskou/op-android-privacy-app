...
/**
 * Test for /appsIdentity/{group}/{app}/{domainurl}
 */
Test('/appsIdentity/{group}/{app}/{domainurl}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         */
        t.test('test getgroupappdomain get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/appsIdentity/{group}/{app}/{domainurl}']['get']['responses']['200']['schema']);
         ...
         * responses: 200, 405
         */
        t.test('test addgroupapp put operation', function (t) {
            Mockgen().requests({
                path: '/appsIdentity/{group}/{app}/{domainurl}',
                operation: 'put'
            }, function (err, mock) {
         ...
         */
        t.test('test updateGroupdomain post operation', function (t) {
            Mockgen().requests({
                path: '/appsIdentity/{group}/{app}/{domainurl}',
                operation: 'post'
            }, function (err, mock) {
