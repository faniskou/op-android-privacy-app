...
/**
 * Test for /statistics/{key}
 */
Test('/statistics/{key}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         */
        t.test('test getpolicy get operation', function (t) {
            Mockgen().requests({
                path: '/statistics/{key}',
                operation: 'get'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/statistics/{key}']['get']['responses']['200']['schema']);
         ...
         * responses: 200, 405
         */
        t.test('test addpolicy put operation', function (t) {
            Mockgen().requests({
                path: '/statistics/{key}',
                operation: 'put'
            }, function (err, mock) {
