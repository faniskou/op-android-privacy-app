...
/**
 * Test for /statistics/{key}/{domainurl}
 */
Test('/statistics/{key}/{domainurl}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         */
        t.test('test getpolicyurl get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/statistics/{key}/{domainurl}']['get']['responses']['200']['schema']);
         ...
         * responses: 200, 405
         */
        t.test('test updatePeturl post operation', function (t) {
            Mockgen().requests({
                path: '/statistics/{key}/{domainurl}',
                operation: 'post'
            }, function (err, mock) {
